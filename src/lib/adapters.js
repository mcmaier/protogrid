...
export const ADAPTER_LIBRARY = [
  ...
  features: {
      copper: [
        ...
        // F.Cu traces
        { type: 'trace', x1: 4.37, y1: 6.275, x2: 3.175, y2: 5.08, w: 0.2 },
        { type: 'trace', x1: 3.175, y1: 5.08, x2: 2.54, y2: 5.08, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 6.275, x2: 4.37, y2: 6.275, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 10.825, x2: 6.32, y2: 10.825, w: 0.2 },
        { type: 'trace', x1: 1.27, y1: 13.97, x2: 0.601, y2: 13.301, w: 0.2 },
        { type: 'trace', x1: 6.32, y1: 10.825, x2: 3.175, y2: 13.97, w: 0.2 },
        { type: 'trace', x1: 0.601, y1: 13.301, x2: 0.601, y2: 12.7, w: 0.2 },
        { type: 'trace', x1: 3.175, y1: 13.97, x2: 1.27, y2: 13.97, w: 0.2 },
        { type: 'trace', x1: 4.699, y1: 10.16, x2: 2.54, y2: 10.16, w: 0.2 },
        { type: 'trace', x1: 5.984, y1: 8.875, x2: 4.699, y2: 10.16, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 8.875, x2: 5.984, y2: 8.875, w: 0.2 },
        { type: 'trace', x1: 4.826, y1: 8.89, x2: 1.27, y2: 8.89, w: 0.2 },
        { type: 'trace', x1: 5.491, y1: 8.225, x2: 4.826, y2: 8.89, w: 0.2 },
        { type: 'trace', x1: 0.601, y1: 8.221, x2: 0.601, y2: 7.62, w: 0.2 },
        { type: 'trace', x1: 1.27, y1: 8.89, x2: 0.601, y2: 8.221, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 8.225, x2: 5.491, y2: 8.225, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 7.575, x2: 2.585, y2: 7.575, w: 0.2 },
        { type: 'trace', x1: 2.585, y1: 7.575, x2: 2.54, y2: 7.62, w: 0.2 },
        { type: 'trace', x1: 4.064, y1: 3.175, x2: 4.064, y2: 2.4362, w: 0.2 },
        { type: 'trace', x1: 4.064, y1: 2.4362, x2: 3.0168, y2: 1.389, w: 0.2 },
        { type: 'trace', x1: 3.0168, y1: 1.389, x2: 1.389, y2: 1.389, w: 0.2 },
        { type: 'trace', x1: 1.389, y1: 1.389, x2: 0.601, y2: 0.601, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 4.325, x2: 5.214, y2: 4.325, w: 0.2 },
        { type: 'trace', x1: 5.214, y1: 4.325, x2: 4.064, y2: 3.175, w: 0.2 },
        { type: 'trace', x1: 3.556, y1: 6.35, x2: 1.27, y2: 6.35, w: 0.2 },
        { type: 'trace', x1: 0.601, y1: 5.681, x2: 0.601, y2: 5.08, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 6.925, x2: 4.131, y2: 6.925, w: 0.2 },
        { type: 'trace', x1: 1.27, y1: 6.35, x2: 0.601, y2: 5.681, w: 0.2 },
        { type: 'trace', x1: 4.131, y1: 6.925, x2: 3.556, y2: 6.35, w: 0.2 },
        { type: 'trace', x1: 4.699, y1: 3.048, x2: 4.699, y2: 2.286, w: 0.2 },
        { type: 'trace', x1: 4.699, y1: 2.286, x2: 3.014, y2: 0.601, w: 0.2 },
        { type: 'trace', x1: 3.014, y1: 0.601, x2: 2.54, y2: 0.601, w: 0.2 },
        { type: 'trace', x1: 5.326, y1: 3.675, x2: 4.699, y2: 3.048, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 3.675, x2: 5.326, y2: 3.675, w: 0.2 },
        { type: 'trace', x1: 0.601, y1: 10.761, x2: 0.601, y2: 10.16, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 9.525, x2: 6.096, y2: 9.525, w: 0.2 },
        { type: 'trace', x1: 6.096, y1: 9.525, x2: 4.191, y2: 11.43, w: 0.2 },
        { type: 'trace', x1: 4.191, y1: 11.43, x2: 1.27, y2: 11.43, w: 0.2 },
        { type: 'trace', x1: 1.27, y1: 11.43, x2: 0.601, y2: 10.761, w: 0.2 },
        { type: 'trace', x1: 4.975, y1: 4.975, x2: 2.54, y2: 2.54, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 4.975, x2: 4.975, y2: 4.975, w: 0.2 },
        { type: 'trace', x1: 3.268, y1: 14.639, x2: 2.54, y2: 14.639, w: 0.2 },
        { type: 'trace', x1: 6.432, y1: 11.475, x2: 3.268, y2: 14.639, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 11.475, x2: 6.432, y2: 11.475, w: 0.2 },
        { type: 'trace', x1: 3.056, y1: 3.691, x2: 0.77, y2: 3.691, w: 0.2 },
        { type: 'trace', x1: 0.77, y1: 3.691, x2: 0.601, y2: 3.522, w: 0.2 },
        { type: 'trace', x1: 0.601, y1: 3.522, x2: 0.601, y2: 2.54, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 5.625, x2: 4.99, y2: 5.625, w: 0.2 },
        { type: 'trace', x1: 4.99, y1: 5.625, x2: 3.056, y2: 3.691, w: 0.2 },
        { type: 'trace', x1: 3.683, y1: 12.7, x2: 2.54, y2: 12.7, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 10.175, x2: 6.208, y2: 10.175, w: 0.2 },
        { type: 'trace', x1: 6.208, y1: 10.175, x2: 3.683, y2: 12.7, w: 0.2 },
        { type: 'trace', x1: 7.2975, y1: 12.125, x2: 6.671, y2: 12.125, w: 0.2 },
        { type: 'trace', x1: 5.842, y1: 12.954, x2: 5.842, y2: 13.843, w: 0.2 },
        { type: 'trace', x1: 6.671, y1: 12.125, x2: 5.842, y2: 12.954, w: 0.2 },
        { type: 'trace', x1: 17.018, y1: 3.81, x2: 18.449, y2: 3.81, w: 0.2 },
        { type: 'trace', x1: 18.449, y1: 3.81, x2: 19.719, y2: 5.08, w: 0.2 },
        { type: 'trace', x1: 15.696, y1: 6.275, x2: 16.383, y2: 5.588, w: 0.2 },
        { type: 'trace', x1: 16.383, y1: 4.445, x2: 17.018, y2: 3.81, w: 0.2 },
        { type: 'trace', x1: 16.383, y1: 5.588, x2: 16.383, y2: 4.445, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 6.275, x2: 15.696, y2: 6.275, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 6.925, x2: 15.8759, y2: 6.925, w: 0.2 },
        { type: 'trace', x1: 15.8759, y1: 6.925, x2: 17.7209, y2: 5.08, w: 0.2 },
        { type: 'trace', x1: 17.7209, y1: 5.08, x2: 17.78, y2: 5.08, w: 0.2 },
        { type: 'trace', x1: 14.105, y1: 3.675, x2: 14.732, y2: 3.048, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 3.675, x2: 14.105, y2: 3.675, w: 0.2 },
        { type: 'trace', x1: 14.732, y1: 3.048, x2: 14.732, y2: 1.905, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 5.625, x2: 15.33, y2: 5.625, w: 0.2 },
        { type: 'trace', x1: 15.875, y1: 4.191, x2: 17.526, y2: 2.54, w: 0.2 },
        { type: 'trace', x1: 15.875, y1: 5.08, x2: 15.875, y2: 4.191, w: 0.2 },
        { type: 'trace', x1: 15.33, y1: 5.625, x2: 15.875, y2: 5.08, w: 0.2 },
        { type: 'trace', x1: 17.526, y1: 2.54, x2: 17.78, y2: 2.54, w: 0.2 },
        { type: 'trace', x1: 16.002, y1: 13.589, x2: 16.637, y2: 13.589, w: 0.2 },
        { type: 'trace', x1: 13.888, y1: 11.475, x2: 16.002, y2: 13.589, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 11.475, x2: 13.888, y2: 11.475, w: 0.2 },
        { type: 'trace', x1: 16.637, y1: 13.589, x2: 17.018, y2: 13.97, w: 0.2 },
        { type: 'trace', x1: 19.05, y1: 13.97, x2: 19.719, y2: 14.639, w: 0.2 },
        { type: 'trace', x1: 17.018, y1: 13.97, x2: 19.05, y2: 13.97, w: 0.2 },
        { type: 'trace', x1: 16.645, y1: 1.151, x2: 18.296, y2: 1.151, w: 0.2 },
        { type: 'trace', x1: 16.256, y1: 1.524, x2: 16.637, y2: 1.143, w: 0.2 },
        { type: 'trace', x1: 19.685, y1: 2.54, x2: 19.719, y2: 2.54, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 4.975, x2: 14.202, y2: 4.975, w: 0.2 },
        { type: 'trace', x1: 18.296, y1: 1.151, x2: 19.685, y2: 2.54, w: 0.2 },
        { type: 'trace', x1: 16.637, y1: 1.143, x2: 16.645, y2: 1.151, w: 0.2 },
        { type: 'trace', x1: 14.202, y1: 4.975, x2: 16.256, y2: 2.921, w: 0.2 },
        { type: 'trace', x1: 16.256, y1: 2.921, x2: 16.256, y2: 1.524, w: 0.2 },
        { type: 'trace', x1: 14.351, y1: 9.525, x2: 14.986, y2: 10.16, w: 0.2 },
        { type: 'trace', x1: 14.986, y1: 10.16, x2: 17.78, y2: 10.16, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 9.525, x2: 14.351, y2: 9.525, w: 0.2 },
        { type: 'trace', x1: 14.09, y1: 4.325, x2: 15.748, y2: 2.667, w: 0.2 },
        { type: 'trace', x1: 15.748, y1: 1.4649, x2: 16.6119, y2: 0.601, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 4.325, x2: 14.09, y2: 4.325, w: 0.2 },
        { type: 'trace', x1: 15.748, y1: 2.667, x2: 15.748, y2: 1.4649, w: 0.2 },
        { type: 'trace', x1: 16.6119, y1: 0.601, x2: 17.78, y2: 0.601, w: 0.2 },
        { type: 'trace', x1: 17.052, y1: 14.639, x2: 17.78, y2: 14.639, w: 0.2 },
        { type: 'trace', x1: 13.776, y1: 12.125, x2: 15.875, y2: 14.224, w: 0.2 },
        { type: 'trace', x1: 16.637, y1: 14.224, x2: 17.052, y2: 14.639, w: 0.2 },
        { type: 'trace', x1: 15.875, y1: 14.224, x2: 16.637, y2: 14.224, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 12.125, x2: 13.776, y2: 12.125, w: 0.2 },
        { type: 'trace', x1: 14, y1: 10.825, x2: 15.875, y2: 12.7, w: 0.2 },
        { type: 'trace', x1: 15.875, y1: 12.7, x2: 17.78, y2: 12.7, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 10.825, x2: 14, y2: 10.825, w: 0.2 },
        { type: 'trace', x1: 16.899, y1: 6.469, x2: 19.423, y2: 6.469, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 7.575, x2: 15.793, y2: 7.575, w: 0.2 },
        { type: 'trace', x1: 15.793, y1: 7.575, x2: 16.899, y2: 6.469, w: 0.2 },
        { type: 'trace', x1: 19.423, y1: 6.469, x2: 19.719, y2: 6.765, w: 0.2 },
        { type: 'trace', x1: 19.719, y1: 6.765, x2: 19.719, y2: 7.62, w: 0.2 },
        { type: 'trace', x1: 19.169, y1: 11.549, x2: 19.719, y2: 12.099, w: 0.2 },
        { type: 'trace', x1: 14.112, y1: 10.175, x2: 15.486, y2: 11.549, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 10.175, x2: 14.112, y2: 10.175, w: 0.2 },
        { type: 'trace', x1: 19.719, y1: 12.099, x2: 19.719, y2: 12.7, w: 0.2 },
        { type: 'trace', x1: 15.486, y1: 11.549, x2: 19.169, y2: 11.549, w: 0.2 },
        { type: 'trace', x1: 18.1228, y1: 8.875, x2: 19.4078, y2: 10.16, w: 0.2 },
        { type: 'trace', x1: 19.4078, y1: 10.16, x2: 19.719, y2: 10.16, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 8.875, x2: 18.1228, y2: 8.875, w: 0.2 },
        { type: 'trace', x1: 17.175, y1: 8.225, x2: 17.78, y2: 7.62, w: 0.2 },
        { type: 'trace', x1: 13.0225, y1: 8.225, x2: 17.175, y2: 8.225, w: 0.2 },        
      ],
      copperBack: [
        { type: 'pad', x: 10.16, y: 7.62, w: 3.05, h: 7.56 },   // Pin 29
        { type: 'trace', x1: 5.715, y1: 13.97, x2: 1.27, y2: 13.97, w: 0.2 },
        { type: 'trace', x1: 5.842, y1: 13.843, x2: 5.715, y2: 13.97, w: 0.2 },
        { type: 'trace', x1: 1.27, y1: 13.97, x2: 0.601, y2: 14.639, w: 0.2 },
        { type: 'trace', x1: 14.732, y1: 1.905, x2: 15.248, y2: 1.389, w: 0.2 },
        { type: 'trace', x1: 19.439, y1: 1.389, x2: 19.719, y2: 1.109, w: 0.2 },
        { type: 'trace', x1: 19.719, y1: 1.109, x2: 19.719, y2: 0.601, w: 0.2 },
        { type: 'trace', x1: 15.248, y1: 1.389, x2: 19.439, y2: 1.389, w: 0.2 },
      ],
      drills: [
        { x: 8.885, y: 11.15, drill: 0.3, size: 0.5 },
        { x: 8.885, y: 9.385, drill: 0.3, size: 0.5 },
        { x: 8.885, y: 7.62, drill: 0.3, size: 0.5 },
        { x: 8.885, y: 5.855, drill: 0.3, size: 0.5 },
        { x: 8.885, y: 4.09, drill: 0.3, size: 0.5 },
        { x: 10.16, y: 11.15, drill: 0.3, size: 0.5 },
        { x: 10.16, y: 9.385, drill: 0.3, size: 0.5 },
        { x: 10.16, y: 7.62, drill: 0.3, size: 0.5 },
        { x: 10.16, y: 5.855, drill: 0.3, size: 0.5 },
        { x: 10.16, y: 4.09, drill: 0.3, size: 0.5 },
        { x: 11.435, y: 11.15, drill: 0.3, size: 0.5 },
        { x: 11.435, y: 9.385, drill: 0.3, size: 0.5 },
        { x: 11.435, y: 7.62, drill: 0.3, size: 0.5 },
        { x: 11.435, y: 5.855, drill: 0.3, size: 0.5 },
        { x: 11.435, y: 4.09, drill: 0.3, size: 0.5 },
        { x: 5.842, y: 13.843, drill: 0.3, size: 0.6 },
        { x: 14.732, y: 1.905, drill: 0.3, size: 0.6 },
      ],
      mask: [
      ...
      silk: [
        { type: 'poly', points: [{ x: 12.47, y: 12.86 }, { x: 7.85, y: 12.86 }] },
        { type: 'poly', points: [{ x: 12.47, y: 12.585 }, { x: 12.47, y: 12.86 }] },
        { type: 'poly', points: [{ x: 12.47, y: 2.94 }, { x: 12.47, y: 3.215 }] },
        { type: 'poly', points: [{ x: 7.85, y: 12.86 }, { x: 7.85, y: 12.585 }] },
        { type: 'poly', points: [{ x: 7.85, y: 3.215 }, { x: 7.85, y: 2.94 }] },
        { type: 'poly', points: [{ x: 7.85, y: 2.94 }, { x: 12.47, y: 2.94 }] },
        { type: 'circle', x: 11.135, y: 10.165, d: 0.25 },        
        ],
    },

      silkText: [
        { type: 'text', text: 'U1', x: 10.16, y: 13.7, height: 1, rotation: 0 },
      ],

    outline: { width: 22.3, height: 17.2 },
    outlineOffset: { x: 0, y: 0 },
    silkLabel: { text: 'TSSOP-28', rotation: 0, x: 9, y: 0, height: 0.9 },
    widthPins: 9,
    heightPins: 7,
  },
